...
contract LTL is ERC721AQueryable, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  address public adminAddress = 0x77CAacb4d8D84C68FB8e33baDADFde8a26AA6d25;
  ...
  string _tokenName = "LTL - ONE LIFE, LIVE IT";
  string _tokenSymbol = "LTL";  
  uint256 _maxSupply = 333;  
  address _defaultRoyaltyReceiver = 0x77CAacb4d8D84C68FB8e33baDADFde8a26AA6d25; //CHANGED
